// Tarea 3 B Unidad 2. Jorge Cordero Gordillo.
...
alert("La operación undefined == 0 es: " + operacion9);
alert("La operación null == 0 es: " + operacion10);
alert("La operación “5” == 5 es: " + operacion11);